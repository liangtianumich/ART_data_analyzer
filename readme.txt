...
Operating system:
This python package depends on some python packages such as pandas, matplotlib, python-tk,scipy, mpl_toolkits, scikit-learn. User need to verify the successful installation of these dependencies in their OS. The package has been tested on python 2.7. Python 3 user may need further tests
