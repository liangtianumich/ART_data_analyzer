...
fprintf(fid,'%f ', 2.9987472714648433e-01); fprintf(fid,'%f ', 3.2130125270428323e+01); fprintf(fid,'%s\n', 'xlo xhi');
fprintf(fid,'%f ', 2.9987472714648433e-01); fprintf(fid,'%f ', 3.2130125270428323e+01); fprintf(fid,'%s\n', 'ylo yhi');
fprintf(fid,'%f ', 2.9987472714648433e-01); fprintf(fid,'%f ', 3.2130125270428323e+01); fprintf(fid,'%s\n\n', 'zlo zhi');
fprintf(fid,'%s\n\n', '  Atoms');
for i=1:1:m
