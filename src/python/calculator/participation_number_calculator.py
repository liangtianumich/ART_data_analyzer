...
def pn_calculator_run_all_tests_mp(path_to_data_dir, input_param, save_results = True):
	list_of_test_id = input_param["list_of_test_id"]
	num_of_proc = input_param["num_of_proc"]
	re_calc = input_param["re_calc"]
	
	operation = lambda x: single_event_pn_calculator(x, path_to_data_dir, re_calc = re_calc)
...
def single_event_pn_calculator(event_state, path_to_data_dir, save_results = True, re_calc = False):
